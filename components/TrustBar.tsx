...
export default function TrustBar() {
  ...
  return (
    <div className="relative overflow-hidden py-5" style={{ background: 'rgba(3,2,10,0.95)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
      <div className="max-w-4xl mx-auto px-6 flex flex-wrap items-center justify-center gap-3 text-xs tracking-[0.15em] uppercase">
        <span className="text-white/25">{t.trust.powered}</span>
