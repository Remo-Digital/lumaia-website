...
export const translations = {
  en: {
    ...
    pricingPage: {
      ...
      meta_desc: 'Transparent pricing for LumAIa. Self-serve modules from CHF 29/month. Pilot Partner plans with full module access.',
      label: 'Pricing',
  ...
  de: {
    ...
    pricingPage: {
      ...
      meta_desc: 'Transparente Preise f\u00fcr LumAIa. Self-Serve-Module ab CHF 29/Monat. Pilot-Partner-Tarife mit vollem Modul-Zugriff.',
      label: 'Preise',
