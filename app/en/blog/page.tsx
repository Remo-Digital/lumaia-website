    ...
    <>
      ...
      <main id="main-content" className="relative min-h-screen pt-28 pb-20 px-6"
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          {/* Blog cards */}
          <section className="grid md:grid-cols-3 gap-6 animate-fade-up-2 mb-16" aria-label="Blog articles">
            {bt.posts.map((post, i) => (
          ...
          {/* Coming soon notice */}
          <section className="glass rounded-2xl p-8 text-center animate-fade-up-3" aria-label="Coming soon notice">
