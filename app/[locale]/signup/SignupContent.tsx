      ...
      <main id="main-content" className="relative min-h-screen pt-28 pb-20 px-6"
        ...
        <div className="relative max-w-2xl mx-auto">
          <header className="text-center mb-12 animate-fade-up-1">
            ...
            <p className="text-white/70 text-lg max-w-md mx-auto">{s.sub}</p>
          </header>

          <section className="glass rounded-2xl p-10 text-center animate-fade-up-2 flex flex-col items-center gap-6" aria-label={s.label}>
            <div
            ...
            <div>
              <p className="text-white/70 text-base leading-relaxed mb-2">{s.comingSoon}</p>
            ...
            <p className="text-white/25 text-xs">{s.noCreditCard}</p>
          </section>
        </div>
      </main>
      <Footer />
