    ...
    <>
      ...
      <main id="main-content" className="relative min-h-screen pt-28 pb-20 px-6"
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <article className="glass rounded-2xl p-8 md:p-12 animate-fade-up-2 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:text-white/80 [&_h2]:mt-10 [&_h2]:mb-4 [&_p]:text-white/45 [&_p]:leading-relaxed [&_p]:mb-4 [&_ul]:text-white/45 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mb-4 [&_li]:leading-relaxed [&_li]:mb-1">
