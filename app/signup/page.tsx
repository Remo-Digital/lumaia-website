    ...
    <>
      ...
      <main id="main-content" className="relative min-h-screen pt-28 pb-20 px-6"
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          {/* Coming soon card */}
          <section className="glass rounded-2xl p-10 text-center animate-fade-up-2 flex flex-col items-center gap-6" aria-label="Registrierung in Kürze">
            {/* Icon */}
            <div
            ...
            <p className="text-white/25 text-xs">Keine Kreditkarte. Kostenlose Demo-Session.</p>
          </section>
        </div>
      </main>
      <Footer />
